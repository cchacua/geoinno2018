...
angular.module('geoinno2018')
        ...
        .service('db', ['$resource', 'baseURL', function($resource,baseURL) {
            ...
            this.getparallel = function(){
                    
                return $resource(baseURL+"&sheet=parallel",null);
            };
                
            this.getsessions = function(){
                return $resource(baseURL+"&sheet=sessions",null);
            };
            
            this.getpapers = function(){
                return $resource(baseURL+"&sheet=papers",null);
            };
